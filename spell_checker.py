...
class EnhancedSpellChecker(BaseChecker):
    ...
    COMMON_MISSPELLINGS = {
        ...
        # British → American English corrections (US dictionary)
        # -ise → -ize
        'organise': 'organize', 'recognise': 'recognize', 'analyse': 'analyze',
        'authorise': 'authorize', 'customise': 'customize', 'initialise': 'initialize',
        'optimise': 'optimize', 'standardise': 'standardize', 'synchronise': 'synchronize',
        'utilise': 'utilize', 'minimise': 'minimize', 'maximise': 'maximize',
        'specialise': 'specialize', 'finalise': 'finalize', 'normalise': 'normalize',
        'prioritise': 'prioritize', 'summarise': 'summarize', 'categorise': 'categorize',
        'characterise': 'characterize', 'digitalise': 'digitalize', 'visualise': 'visualize',
        'materialise': 'materialize', 'realise': 'realize', 'capitalise': 'capitalize',
        'centralise': 'centralize', 'localise': 'localize', 'modernise': 'modernize',
        'stabilise': 'stabilize', 'neutralise': 'neutralize', 'legalise': 'legalize',
        'penalise': 'penalize', 'rationalise': 'rationalize', 'terrorise': 'terrorize',
        'nationalise': 'nationalize', 'generalise': 'generalize', 'formalise': 'formalize',
        'idealise': 'idealize', 'hospitalise': 'hospitalize', 'patronise': 'patronize',
        'harmonise': 'harmonize', 'mobilise': 'mobilize', 'memorise': 'memorize',
        'apologise': 'apologize', 'symbolise': 'symbolize', 'mechanise': 'mechanize',
        'emphasise': 'emphasize', 'revitalise': 'revitalize', 'itemise': 'itemize',
        # -ised → -ized
        'organised': 'organized', 'recognised': 'recognized', 'analysed': 'analyzed',
        'authorised': 'authorized', 'customised': 'customized', 'initialised': 'initialized',
        'optimised': 'optimized', 'standardised': 'standardized', 'synchronised': 'synchronized',
        'utilised': 'utilized', 'minimised': 'minimized', 'maximised': 'maximized',
        'specialised': 'specialized', 'finalised': 'finalized', 'normalised': 'normalized',
        'prioritised': 'prioritized', 'summarised': 'summarized', 'categorised': 'categorized',
        'realised': 'realized', 'capitalised': 'capitalized', 'centralised': 'centralized',
        'localised': 'localized', 'modernised': 'modernized', 'stabilised': 'stabilized',
        'formalised': 'formalized', 'mobilised': 'mobilized', 'memorised': 'memorized',
        'emphasised': 'emphasized', 'visualised': 'visualized',
        # -ising → -izing
        'organising': 'organizing', 'recognising': 'recognizing', 'analysing': 'analyzing',
        'authorising': 'authorizing', 'customising': 'customizing', 'initialising': 'initializing',
        'optimising': 'optimizing', 'utilising': 'utilizing', 'minimising': 'minimizing',
        'maximising': 'maximizing', 'specialising': 'specializing', 'prioritising': 'prioritizing',
        'summarising': 'summarizing', 'categorising': 'categorizing', 'emphasising': 'emphasizing',
        'realising': 'realizing', 'visualising': 'visualizing', 'modernising': 'modernizing',
        # -isation → -ization
        'organisation': 'organization', 'organisations': 'organizations',
        'optimisation': 'optimization', 'standardisation': 'standardization',
        'synchronisation': 'synchronization', 'utilisation': 'utilization',
        'specialisation': 'specialization', 'normalisation': 'normalization',
        'prioritisation': 'prioritization', 'categorisation': 'categorization',
        'centralisation': 'centralization', 'localisation': 'localization',
        'modernisation': 'modernization', 'stabilisation': 'stabilization',
        'rationalisation': 'rationalization', 'nationalisation': 'nationalization',
        'generalisation': 'generalization', 'formalisation': 'formalization',
        'visualisation': 'visualization', 'materialisation': 'materialization',
        'capitalisation': 'capitalization', 'hospitalisation': 'hospitalization',
        'mobilisation': 'mobilization', 'mechanisation': 'mechanization',
        'characterisation': 'characterization', 'digitalisation': 'digitalization',
        # -our → -or
        ...
        'armour': 'armor', 'armoured': 'armored', 'armouring': 'armoring',
        'humour': 'humor', 'humours': 'humors', 'humoured': 'humored', 'humorous': 'humorous',
        ...
        # -t → -ed (British past tense)
        'learnt': 'learned', 'spelt': 'spelled', 'spoilt': 'spoiled',
        'spilt': 'spilled', 'dreamt': 'dreamed', 'burnt': 'burned', 'leapt': 'leaped',
        ...
        'pyjamas': 'pajamas',
        'sceptical': 'skeptical',
        'storey': 'story', 'storeys': 'stories',  # building floors
        'sulphur': 'sulfur',
