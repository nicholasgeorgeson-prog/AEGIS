...
Usage:
    ...
    python apply_v5.9.40.py
    python3 apply_v5.9.40.py
...
FILES = [
    ...
    # Proposal Compare (new v2.0 module)
...
def main():
    ...
    print()
    print("  =============================================")
    print("    AEGIS v5.9.40 Direct Updater")
    print("    Proposal Compare v2.0 + Bug Fixes")
    print("  =============================================")
    print()
    print("  PROPOSAL COMPARE v2.0:")
    print("    - 8 result tabs (exec summary, red flags,")
    print("      heatmap, vendor scores, comparison,")
    print("      categories, details, raw tables)")
    print("    - Project management (group proposals)")
    print("    - Chart.js integration (optional)")
    print("    - M&A dashboard Proposals tab")
    print()
    print("  BUG FIXES:")
    print("    - Export Highlighted crash on Windows")
    print("    - Boot error (missing /api/capabilities)")
    print("    - Proposal Compare behind dashboard tiles")
    print("    - Batch scan Docling stability (Windows)")
    print()
    ...
    backup_dir = os.path.join(install_dir, "backups", f"pre_v5.9.40_{timestamp}")
    ...
    if failed == 0:
        ...
        print("    4. Click the Proposal Compare tile to try the new v2.0!")
        print()
