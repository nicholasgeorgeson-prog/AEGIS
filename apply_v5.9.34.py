...
Usage:
    ...
    python apply_v5.9.34.py
    python3 apply_v5.9.34.py
...
def main():
    ...
    print()
    print("  =============================================")
    print("    AEGIS v5.9.34 Direct Updater")
    print("    FIX: 413 Upload Limit for Excel Export")
    print("  =============================================")
    print()
    ...
    backup_dir = os.path.join(install_dir, "backups", f"pre_v5.9.34_{timestamp}")
    ...
    if failed == 0:
        ...
        print()
        print("  IMPORTANT: This update changes app.py (server startup).")
        print("  You MUST restart AEGIS for this fix to take effect.")
        print()
        print("  NEXT STEPS:")
