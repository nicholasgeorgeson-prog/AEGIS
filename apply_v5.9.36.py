...
Usage:
    ...
    python apply_v5.9.36.py
    python3 apply_v5.9.36.py
...
def main():
    ...
    print()
    print("  =============================================")
    print("    AEGIS v5.9.36 Direct Updater")
    print("    Proposal Compare + Batch Dashboard")
    print("  =============================================")
    print()
    print("  NEW FEATURE:")
    print("    - Proposal Compare tool (upload DOCX/PDF/XLSX,")
    print("      extract financials, side-by-side comparison)")
    print("    - Comparison engine with line item alignment")
    print("    - XLSX export with 3 sheets + AEGIS branding")
    print("    - Landing page tile (purple accent)")
    print("    - 16 narrated demo scenes with TTS audio")
    print("    - Help documentation (4 new sections)")
    print()
    print("  ENHANCEMENTS:")
    print("    - Batch scan progress: Issues + Roles counters")
    print("    - Scan completion: words/issues/roles/score")
    print("    - Version history updated in Help & Docs")
    print()
    ...
    backup_dir = os.path.join(install_dir, "backups", f"pre_v5.9.36_{timestamp}")
